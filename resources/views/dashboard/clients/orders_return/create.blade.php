                                ...
                                <div class="row">
                                            ...
                                            <select name="store_id" class="form-control">
                                                ...
                                                @foreach ($stores as $store)
                                                    <option value="{{ $store->id }}"
                                                        {{ request()->stores_id == $store->id ? 'selected' : '' }}>
                                                        {{ $store->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                            ...
                                            <select name="mony_stock_id" class="form-control">
                                                ...
                                                @foreach ($mony_stocks as $mony_stock)
                                                    <option value="{{ $mony_stock->id }}"
                                                        {{ request()->mony_stock_id == $mony_stock->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="order_date" step="1" class="form-control"
