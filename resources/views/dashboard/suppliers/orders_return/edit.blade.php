                                    ...
                                    <div class="col-md-8">
                                        ...
                                        @if (auth()->user()->hasPermission('create_products'))
                                            <a href="{{ route('dashboard.products.create') }}"
                                                class="btn btn-success ">@lang('site.addprod')<i
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-header">
                            ...
                            <h3 class="box-title">@lang('site.orders_suppliers_return')</h3>
                        ...
                        <div class="box-body">
                            ...
                            <form
                                action="{{ route('dashboard.suppliers.orders_return.update', ['orders_return' => $orders_return->id,'supplier' => $supplier->id]) }}"
                                method="post">
                                            ...
                                            <select name="store_id" class="form-control">
                                                ...
                                                @foreach ($stores as $store)
                                                    <option value="{{ $store->id }}"
                                                        {{ $orders_return->store_id == $store->id ? 'selected' : '' }}>
                                                        {{ $store->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                            ...
                                            <select name="mony_stock_id" class="form-control">
                                                ...
                                                @foreach ($mony_stocks as $mony_stock)
                                                    <option value="{{ $mony_stock->id }}"
                                                        {{ $orders_return->mony_stock_id == $mony_stock->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="order_date" class="form-control"
                                                value="{{ $orders_return->order_date }}">
                                ...
                                <h4>@lang('site.total') : <span
                                        class="total-price">{{ number_format($orders_return->total_price, 2) }}</span>
                                </h4>
                    ...
                    @if ($supplier->orders_return->count() > 0)
                        <div class="box box-primary">
