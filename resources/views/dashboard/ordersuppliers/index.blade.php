...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>@lang('site.orders_suppliers')
                <small>({{ $orders_suppliers->total() }})</small>
            </h1>

            <ol class="breadcrumb">
                <li><a href="{{ route('dashboard.welcome') }}"><i class="fa fa-dashboard"></i> @lang('site.dashboard')</a></li>
                <li class="active">@lang('site.orders_suppliers')</li>
            </ol>
        </section>
                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-header">
                            ...
                            <h3 class="box-title" style="margin-bottom: 10px">@lang('site.orders_suppliers')</h3>

                            <form action="{{ route('dashboard.orders_suppliers.index') }}" method="get">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary btn-sm order-products"
                                                        data-url="{{ route('dashboard.orders_suppliers.products', $order->id) }}"
                                                        data-method="get"
                                                >
                                                ...
                                                @if (auth()->user()->hasPermission('update_orders_suppliers'))
                                                    <a href="{{ route('dashboard.suppliers.orders.edit', ['supplier' => $order->supplier->id, 'order' => $order->id]) }}" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> @lang('site.edit')</a>
                                                @else
                                                ...
                                                @if (auth()->user()->hasPermission('delete_orders_suppliers'))
                                                    <form action="{{ route('dashboard.orders_suppliers.destroy', $order->id) }}" method="post" style="display: inline-block;">
                                                        {{ csrf_field() }}
                                                        {{ method_field('delete') }}
