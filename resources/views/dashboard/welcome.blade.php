        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-blue">
                        <div class="inner">
                            <h3>{{ $orders_return_count }}</h3>

                            <p>@lang('site.orders_return')</p>
                        </div>
                        <div class="icon">
                            <i class="fa fa-users"></i>
                        </div>
                        <a href="{{ route('dashboard.orders_return.index') }}" class="small-box-footer">@lang('site.read') <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                {{--suppliers--}}
                <div class="col-lg-3 col-xs-6">
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-blue">
                        <div class="inner">
                            <h3>{{ $orders_suppliers_return_count }}</h3>

                            <p>@lang('site.orders_suppliers_return')</p>
                        </div>
                        <div class="icon">
                            <i class="fa fa-users"></i>
                        </div>
                        <a href="{{ route('dashboard.ordersuppliers_return.index') }}" class="small-box-footer">@lang('site.read') <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                {{--users--}}
                <div class="col-lg-3 col-xs-6">
