...
class OrderReturnController extends Controller
{
    ...
    public function edit(Client $client, OrderReturn $orders_return)
    {
        ...
        $categories = Category::with('products')->get();
        $orders = $client->orders_return()->with('products')->paginate(5);
        //dd($orders_return1);

        return view('dashboard.clients.orders_return.edit', compact('client', 'orders_return', 'orders','categories', 'stores', 'mony_stocks'));
    } //end of edit
